...
assignemntRouter.get("/", (req, res) => {
  ...
  assignemntRouter.put("/:id", (req, res) => {
  ...
  assignemntRouter.delete("/:id", (req, res) => {
    const assignmentId = +req.params.id;
  ...
  export default assignemntRouter;